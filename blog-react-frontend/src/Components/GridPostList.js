...
export default function GridPostList() {
        ...
        return (
            <div>
                ...
                <Dialog
                    ...
                    <DialogActions>
                        <Button onClick={closeCategoryDialog}>Hủy</Button>
                    </DialogActions>
                </Dialog>
            </div>
        );
                    ...
                    <Grid container spacing={2}>
                        ...
                        <Grid item md={12} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                            <TextField
                                ...
                                onFocus={() => handleError('', 'getCategoryName')} fullWidth label='Tên thể loại'
                                onChange={(event) => setCategoryName(event.target.value)} />
                        </Grid>

                        <Grid item md={12}>
                            <Button onClick={handleSubmitCategory} variant='outlined'>Thêm thể loại</Button>
                        </Grid>
                    </Grid>
                </div>
    ...
    const handlePosterUpdate = async () => {
        ...
        Swal.fire({
            title: 'Bạn có chắc thay đổi bài viết này?',
            showDenyButton: true,
                    ...
                    <Grid container spacing={5}>
                        <Grid item md={12}>
                            <TextField
                                ...
                                variant='outlined' fullWidth label='Thêm tiêu để'
                            />
                        </Grid>
                        ...
                        <Grid item md={3}>
                            <LocalizationProvider dateAdapter={AdapterDayjs} >
                                <DemoContainer components={['DatePicker']} >
                                    <DatePicker className={classes.roundedTextField} label="Thời gian" value={dayjs(getDate)} onChange={handleDate} />
                                </DemoContainer>
                    ...
                    <Box sx={style}>
                        ...
                        <Grid container spacing={3}>
                            ...
                            <Grid item md={6}>
                                <LocalizationProvider dateAdapter={AdapterDayjs}>
                                    <DemoContainer components={['DatePicker']}>
                                        <DatePicker label="Thời gian" value={dayjs(getDate)} onChange={handleDate} />
                                    </DemoContainer>
                                </LocalizationProvider>
                            </Grid>
                        ...
                        <Grid container spacing={3} style={{ display: 'flex', justifyContent: 'right', alignItems: 'center', marginTop: '3%' }}>
                            <Grid item md={5} style={{ display: 'flex', justifyContent: 'right', alignItems: 'center' }}>
                                <Button startIcon={<SaveIcon />} onClick={handleUpdatePost} variant='outlined' style={{ marginRight: '2%', borderColor: '#0069ff', color: '#0069ff' }}>Sửa</Button>
                                <Button startIcon={<CancelIcon />} onClick={handleQuickEditClose} variant='outlined' style={{ marginLeft: '2%', borderColor: 'red', color: 'red' }}>Hủy</Button>
                            </Grid>
                        </Grid>
                    </Box>
                </Modal>
