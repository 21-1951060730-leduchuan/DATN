...
export default function CategoryList() {
        ...
        return (
            <div>
                <Grid container spacing={1} style={{ display: 'flex', alignItems: 'center' }}>
                    <Grid item xs={6}>
                        <span style={{ fontWeight: '600', fontSize: '25px' }}>Thể loại</span>
                    </Grid>
                    <Grid item xs={6}>
        ...
        return (
            <div>
                <Dialog
                    ...
                    <DialogActions>
                        <Button startIcon={<SaveIcon />} onClick={handleUpdateCategoryData} variant='outlined' style={{ marginRight: '1%', borderColor: '#0069ff', color: '#0069ff' }}>Sửa</Button>
            ...
            <div>
                <div style={{ padding: '5%' }}>
                    <Grid container spacing={1}>
                        ...
                        <Grid item md={12}>
                            <h3 style={{fontWeight: '600', fontSize: '23px', color: '#0069ff'}}><span style={{color: 'black'}}>Thể loại:</span> {getCategoryName}</h3>
                        </Grid>
                        ...
                        {getBtnStatus ? <Grid container spacing={0} className='center' style={{margin: '3% 0'}}>
                            <Grid item md={6} className='right'>
                                <Button startIcon={<SaveIcon />} onClick={handleUpdatePoster} variant='outlined' style={{ marginRight: '2%', borderColor: '#0069ff', color: '#0069ff' }}>Sửa</Button>
                            </Grid>
                        ...
                        <Grid item md={12}>
                            <TextField
                                ...
                                value={getCategoryName} fullWidth label='Tên thể loại'
    ...
    const columns = [
        { field: 'categoryname', headerName: 'Tiêu đề', width: 1100 },
        {
            field: 'edit',
            headerName: 'Sửa',
            width: 100,
