...
export default function Page() {
    ...
    const handleUpdatePage = async () => {
        Swal.fire({
            title: 'Bạn có chắc thay đổi trang này?',
            showDenyButton: true,
            ...
            <div style={{ height: 'auto', width: '90%', marginTop: '3%' }}>
                ...
                <Grid container spacing={1} style={{ display: 'flex', alignItems: 'center' }}>
                    ...
                    <Grid item xs={6} style={{ display: 'flex', alignItems: 'center', justifyContent: 'right' }}>
                        <span>
                            <Fab style={{ background: '#0069ff', color: 'white' }} aria-label="Thêm" onClick={handleOpenPageDialog}>
                                <AddIcon />
                            </Fab>
                        </span>
                    </Grid>
                    ...
                    <Grid item md={3}>
                        <LocalizationProvider dateAdapter={AdapterDayjs}>
                            <DemoContainer components={['DatePicker']}>
                                <DatePicker label="Thời gian" onChange={handleDate} value={dayjs(getPageDate)} className={classes.roundedTextField} />
                            </DemoContainer>
            ...
            <div>
                <Grid container spacing={2} style={{ padding: '0 3%' }}>
                    ...
                    <Grid item md={3}>
                        <LocalizationProvider dateAdapter={AdapterDayjs}>
                            <DemoContainer components={['DatePicker']}>
                                <DatePicker label="Thời gian" onChange={handleDate} className={classes.roundedTextField} />
                            </DemoContainer>
                        </LocalizationProvider>
                    </Grid>
