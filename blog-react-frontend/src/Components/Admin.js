                    ...
                    <Box sx={style}>
                        ...
                        <Grid container spacing={3} style={{ marginTop: '1%' }}>
                            <Grid item md={6}>
                                <TextField
                                    ...
                                    fullWidth value={getAdminName} onChange={(event) => setAdminName(event.target.value)} label='Tên' />
                            </Grid>
                        ...
                        <Grid container spacing={3} style={{ display: 'flex', justifyContent: 'right', alignItems: 'center', marginTop: '3%' }}>
                            <Grid item md={5} style={{ display: 'flex', justifyContent: 'right', alignItems: 'center' }}>
                                <Button startIcon={<SaveIcon />} onClick={handleUpdateAdminData} variant='outlined' style={{ marginRight: '2%', borderColor: '#0069ff', color: '#0069ff' }}>Sửa</Button>
                            </Grid>
                        </Grid>
                    </Box>
                </Modal>
                        ...
                        <div style={{ width: '100%', display: 'flex', flexDirection: 'row', alignItems: 'start', position: 'relative' }}>
                            ...
                            <Grid item md={6} style={{
                                ...
                                <Grid item xs={6} style={{ marginBottom: '5%' }}>
                                    ...
                                    <p style={{ opacity: '80%', fontSize: '14px' }}>Thông tin này có thể chỉnh sửa</p>
                                </Grid>

                                <Grid container spacing={3} style={{ paddingRight: '3%' }}>
                                    <Grid item xs={6}>
                                        <TextField className={classes.roundedTextField} label="Tên" fullWidth value={item.name} />
                                    </Grid>
                                    ...
                                    <Grid item xs={6}>
                                        <TextField className={classes.roundedTextField} label="Số điện thoại" fullWidth value={item.phone} />
                                    </Grid>
